          ...
          <div class="row">
            <div class="col-md-12 text-center" data-aos="fade-in" >
              ...
              <h2 class="section-title mb-30">
                ...
                <span class="text-marked"> Food delivery app_</span>
              </h2>
            </div>
            <div class="mt-20 m-auto">
              <div class="col-12">
                <Tabs defaultActiveKey="CustomerApp">
                  ...
                  <Tab
                    className="nav-link"
                    eventKey="RestaurantApp"
                    title="Restaurant App (Owner)"
                  >
                    <div class="fade show active" id="secondtab">
                      <div class="row">
                        <div class="col-md-12 text-center">
                          <a href="https://drive.google.com/file/d/126ISvupdVYAPbCnC466yaZHHG-NpzFPf/view?usp=sharing">
                            <img
                              class="img-fluid"
                              src="http://cscodetech.com/mockup/eatggy-small-banner-restro.png"
                            />
                          </a>
                          <p>
                            ID 1:<br></br>
                  ...
                  <Tab
                    className="nav-link"
                    eventKey="estroPanel"
                    title="Restaurant Panel (Owner)"
                  >
                    <div class="fade show active" id="fivetab">
                      <div class="row">
                        <div class="col-md-12 text-center">
                          <a href="http://eatggy.cscodetech.com/">
                            <img
