...
<h1 class="section-title mb-30">Let’s Talk <br/>About Your Laravel Project</h1>
</div>
</div>
</div>
...
<HirePageSer 
  title="Our Expertise"
  he1="Custom Laravel Web Development"
  he2="Laravel Enterprise Application Development"
  he3="Laravel eCommerce Application Development"
  he4="Laravel API Development"
  he5="Migration to Laravel"
  he6="Laravel Support & Maintenance"
  p1="Hire certified Laravel engineers who are experts in developing custom web applications using less effort and codes. Scalable web apps to adjust your growing business needs."
  p2="We have remote Laravel coders for hire who can build web applications customized for your enterprise needs. Hire at flexible rates for full-time and hourly."
  p3="Build highly interactive eCommerce solutions to scale up your sales and business. Hiring offshore Laravel developers from India can make it easy to go online."
  p4="At cscodetech, we have a team of skilled offshore Laravel developers to make your API integrations much simpler. Build or integrate APIs at ease."
  p5="Want to migrate from legacy to Laravel? Hire dedicated Laravel engineers from the USA and upgrade to Laravel with no data loss."
  p6="Keep your web applications bugs-free with our remote Laravel developers. No security or software glitches when you have cscodetech."
/>
