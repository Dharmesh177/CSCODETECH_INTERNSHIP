            ...
            <div class="col-lg-12">
              <Accordion defaultActiveKey={["0"]} alwaysOpen flush>
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    {" "}
                    How much time does it take to develop a Bot application project?
                  </Accordion.Header>
                  <Accordion.Body>
                    <div class="panel-body">
                      <p>
                        ...
                        <a
                          ...
                          href="Bot-app-development.shtml"
                        >
                          Bot app development
                        </a>{" "}
                ...
                <Accordion.Item eventKey="1">
                  <Accordion.Header>
                    How to hire a dedicated team or developer for my Bot
                    project?
                  </Accordion.Header>
                  <Accordion.Body>
                    <div class="panel-body">
                      ...
                      <p>
                        - We will make you talk to the head of the Bot
                        department.
                      </p>
                ...
                <Accordion.Item eventKey="5">
                  ...
                  <Accordion.Body>
                    ...
                    satisfaction is as important to us as the quality of Bot
                ...
                <Accordion.Item eventKey="6">
                  <Accordion.Header>
                    Bot Development Team or Single Developer, What is the
                    best choice?
                  </Accordion.Header>
                  <Accordion.Body>
                    ...
                    excellent Bot developers. Still, a team always makes the
                    best output as more brains are working on a similar project.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="7">
                  <Accordion.Header>
                    What is the Average cost of developing an Bot
                  ...
                  <Accordion.Body>
                    <div class="panel-body">
                      <p>
                        ...
                        developing an Bot Application.
                      </p>
                      <p>- Size of the Bot App project.</p>
                      <p>
                ...
                <Accordion.Item eventKey="8">
                  ...
                  <Accordion.Body>
                    <div class="panel-body">
                      ...
                      Bot application development is 4.5-7 years. Our
