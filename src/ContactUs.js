...
<h1 class="section-title mb-30">Let’s Talk <br/>About Project</h1>
</div>
</div>
</div>
...
<section class="parallax nw-tab-man contact-connect">
<div class="container">
<div class="row">
<div class="col-md-12">
<div class="soln-heading" data-aos="fade-in">

<h2>Would you like to consult for Sales, Career, or Other?</h2>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-in">
<div class="brand-box">
<h3>Business Consultant</h3>
<ul>
<li><PhoneIcon/><a href="#"> +91 7276465975</a></li>
<li><EmailIcon /><a href="mailto:hello@cscodetech.com">hello@cscodetech.com</a></li>
<li><VideocamIcon/><a href="#"> CSCODETECH</a></li>
</ul>
</div>
</div>
 <div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-in">
...
<h3>HR Manager</h3>
<ul>
<li><PhoneIcon/><a href="callto:079-48480990"> 7276465975</a></li>
<li><EmailIcon /><a href="mailto:career@cscodetech.com"> career@cscodetech.com</a></li>
</ul>
</div>
</div>
<div class="col-lg-4 col-md-6 col-sm-12" data-aos="fade-in">
...
/>
<HirePageSer
  title="Hire Our Flutter Developers For FullStack Services"
  he1="Flutter Dart App Development"
  he2="Cross-platform App Development"
  he3="Flutter Web Development"
  he4="Flutter Support & Maintenance"
  he5="Flutter API Development"
  he6="Flutter 2.8 App Upgrade"
  p1="The certified Flutter engineers at iCoderz use Dart programming language to build high-performing applications with easy and quick executions."
  p2="Hire dedicated Flutter developers to build top-notch android and iOS applications using reusable Flutter code libraries. We offer cross-platform apps that offer native experiences."
  p3="If you don't want to invest separately to develop desktop apps, you can avail our custom flutter web app development services. Hire our talented flutter coders to get scalable flutter web apps."
  p4="With our offshore flutter support and maintenance services, you can always keep your flutter apps up and running. Hire our remote flutter app developers who can fix all bugs and security issues."
  p5="We can easily create custom APIs or help you integrate APIs seamlessly. Hire dedicated flutter app developers to make your API integrations easier and quicker."
  p6="Upgrading to the latest versions is significant for your flutter applications' seamless operation and success. We offer a team of flutter programmers for hire to help you update to the latest versions smoothly."
/> */}
<HowToHire/>
<WhyCSC/>
{/* <Accordian/> */}
