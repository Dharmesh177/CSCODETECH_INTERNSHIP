     ...
     <div class="container">
       <div class="row">
         <div class="top-new-top-clickitle text-center">
           <h2>Top Features</h2>
           <p>We strive to create something that doubles up your revenues and attracts more service to your business with an attractive UI/UX that will make your customers come back with the assistance of our well known Vender delivery clone script. It’s time to develop on demand Vender App Development for your business and fly upwards with revenues</p>
         </div>
       </div>
     </div>
         ...
         <div class="row">
              <div class="col-md-12">
                <div class="list-app-con text-center">
                  ...
                  <p>A Customer Application is designed with ease to help the customers place their service <br></br>delivery order by browsing multiple restaurants and its menu.</p>
                </div>
              </div>
              <div class="col-lg-4 text-center col-md-12 col-sm-12">
                <div class="app-img-main">
                <img class="lazyload img-fluid" loading="lazyload" data-src="img/hungry-grocery-customer-app.png" src="img/hungry-grocery-customer-app.png" alt="Surat’s Prominent Chinese s Delivery App" title="Surat’s Prominent Chinese service Delivery App"/>
               </div>Vender
              </div> 
                  ...
                  <ul>
                    ...
                    <li>
                        ...
                        <div class="app-feature-type">
                            ...
                            <p>The users can place the order as per their desired time by usinVenderg this schedule option. Actually, this option is so cool for the users to get s.</p>
                        </div>
                    </li>
                    <li>
                        <span>3</span>
                        <div class="app-feature-type">
                            ...
                            <p>Customer will receive notifications as soon as he placed the order. He will receive the notification since his service will start preparing, delivery man will start from store, delivery man will complete the order.</p>
                        </div>
                    </li>
         ...
         <div class="container-fluid">
           <div class="row">
               ...
               <div class="feature-list-main">
                 <ul>
                   ...
                   <li>
                       ...
                       <div class="app-feature-type">
                           <h5>Order History </h5>
                           <p>Drivers can save and manage all on going & completed order information of Vender orders and deliveries on the app.</p>
                       </div>
                   </li>
                   <li>
                       <span>4</span>
             ...
             <div class="col-lg-4 text-center col-md-5 col-sm-12 desktop-about-img">
               <div class="app-img-main">
                 <img class="lazyload img-fluid" loading="lazyload" data-src="img/eatggy-multi-restaurant-delivery-app.png" src="img/eatggy-multi-restaurant-delivery-app.png" alt="Kolkata’s Prominent Chinese Vender Delivery App" title="Kolkata’s Prominent Chinese Vender Delivery App"/>
               </div>
             </div> 
           </div>
         </div>
