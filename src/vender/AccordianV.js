...
function Accordian(){
    return (
       ...
       <div class="wrapper faq-wrapper pt-10" >
        <div class="container">
           <div class="row">
                <div class="col-md-12">
                    <h2 class="section-title mb-40" data-aos="fade-in"><span class="text-marked">Frequently Asked</span> Questions_</h2>
                </div>
            </div>
  ...
  <Accordion.Item eventKey="0">
    <Accordion.Header>How Much it Costs To Develop A Single Vender App?</Accordion.Header>
    <Accordion.Body>
    
                                    The cost of developing a Single Vender app is dependent on the complexity of functionalities in the app. A multi-vendor app costs much more than a single vendor app.
  ...
  <Accordion.Item eventKey="1">
    <Accordion.Header>How long it takes to develop a single Vender app?</Accordion.Header>
    <Accordion.Body>
  ...
  <Accordion.Item eventKey="8">
    ...
    <Accordion.Body>
    Yes, definitely we will upload your application to the Play Store as this is included in the development Venders offered by us. We will submit your app for review as well as approval. As we hold wide experience in developing and deploying applications to different stores, we can do the uploading task easily and you can sit back, relax and use the app once it is uploaded.
                                               
    </Accordion.Body>
  </Accordion.Item>
  <Accordion.Item eventKey="9">
    <Accordion.Header>
    How often can I get your support / Vender?
    </Accordion.Header>
    <Accordion.Body>
