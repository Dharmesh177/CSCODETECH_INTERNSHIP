...
import ExpertiseE from "./ExpertiseEnter";
          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6">
              <div class="text-left mauto">
                ...
                <h1 data-aos="fade-in" class="section-title mb-30">Top Enterprise Software Development Services</h1>
                <p>Are you launching your eCommerce or mCommerce business anytime soon? We have the best on-demand app development solutions such as delivery apps, appointment booking apps, ride-hailing apps, photo and video editing apps, etc.</p>
