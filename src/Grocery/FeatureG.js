     ...
     <div class="container">
       <div class="row">
         <div class="top-new-top-clickitle text-center">
           <h2>Top Features</h2>
           <p>We strive to create something that doubles up your revenues and attracts more Groceries to your business with an attractive UI/UX that will make your customers come back with the assistance of our well known Grocer delivery clone script. It’s time to develop on demand Grocer delivery app for your business and fly upwards with revenues</p>
         </div>
       </div>
     </div>
     ...
     <div class="new-top-div">
       <nav id="top-menu">
         <ul>
           ...
           <li><a href="#app-layout-main1">Website</a></li>
         ...
         <div class="row">
              ...
              <div class="col-lg-4 text-center col-md-12 col-sm-12">
                <div class="app-img-main">
                  <img class="lazyload img-fluid" loading="lazyload" data-src="img/hungry-grocery-customer-app.png" src="img/hungry-grocery-customer-app.png" alt="Surat’s Prominent Chinese Food Delivery App" title="Surat’s Prominent Chinese Food Delivery App"/>
                </div>
              </div> 
                  ...
                  <ul>
                    <li>
                        ...
                        <div class="app-feature-type">
                            <h5>Simplified Sign-Up / Sign-In</h5>
                            <p>We have the most vital feature where we can easily register with the phone number with OTP.</p>
                        </div>
                    </li>
                    <li>
                        <span>2</span>
                        <div class="app-feature-type">
                            ...
                            <p>The users can place the order as per their desired time by using this schedule option. Actually, this option is so cool for the users to get groceries.</p>
                        </div>
                    </li>
                    <li>
                        <span>3</span>
                        <div class="app-feature-type">
                            ...
                            <p>Customer will receive notifications as soon as he placed the order. He will receive the notification since his food will start preparing, delivery man will start from store, delivery man will complete the order.</p>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="app-feature-type">
                            ...
                            <p>We provide an option for the customers to enjoy promos and offers which increases retention and engagement.</p>
                        </div>
                    </li>
                    <li>
                        <span>5</span>
                        <div class="app-feature-type">
                            ...
                            <p>Customers are provided with multiple options to make a payment. We have Cash on Delivery (COD) ,PayPal, Stripe, Razorpay enabled‌</p>
                        </div>
                    </li>
                    <li>
                        <span>6</span>
                        <div class="app-feature-type">
                            <h5>Order/Cancel Groceries</h5>
                            <p>Customers get the freedom to place/cancel order online as per their preferences.</p>
                        </div>
                    </li>
                    <li>
                        <span>7</span>
                        <div class="app-feature-type">
                            ...
                            <p>This feature allows customers to refer to the Swiggy clone app to friends & family. Upon successful referral, the amount will be credited to customers in-app wallet.</p>
                        </div>
                    </li>
                    <li>
                        <span>8</span>
                        <div class="app-feature-type">
                            <h5>History Orders</h5>
                            <p>Items can be saved in app so that you can check them in the future.</p>
                        </div>
                    </li>
                  </ul>
                </div>
         ...
         <div class="container-fluid">
           <div class="row">
               ...
               <div class="feature-list-main">
                 <ul>
                   ...
                   <li>
                       ...
                       <div class="app-feature-type">
                           <h5>Order History </h5>
                           <p>Drivers can save and manage all on going & completed order information of Grocer orders and deliveries on the app.</p>
                       </div>
                   </li>
                   <li>
                       <span>4</span>
             ...
             <div class="col-lg-4 text-center col-md-5 col-sm-12 desktop-about-img">
               <div class="app-img-main">
                 <img class="lazyload img-fluid" loading="lazyload" data-src="img/eatggy-multi-restaurant-delivery-app.png" src="img/eatggy-multi-restaurant-delivery-app.png" alt="Kolkata’s Prominent Chinese Grocer Delivery App" title="Kolkata’s Prominent Chinese Grocer Delivery App"/>
               </div>
             </div> 
           </div>
         </div>
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <div class="list-app-con text-center">
                  <div class="col-md-12" data-aos="fade-in">
                    <h2 class="section-title">Web<span class="text-marked">site_</span></h2>
                </div>
                   
                    <p>Allow your customers to place an order for their favorite Grocery using a web app.</p>
                </div>
              </div>
                ...
                <div class="feature-list-main">
                  <ul>
                    <li>
                        <span>1</span>
                        <div class="app-feature-type">
                            <h5>Easy Cart Management</h5>
                            <p>Users can view the active order list and the status updates for each active order- canceled, accepted, on the way for delivery, and more.</p>
                        </div>
                    </li>
                    <li>
                        <span>2</span>
                        <div class="app-feature-type">
                            <h5>Effortless Payment Gateway</h5>
                            <p>Users get multiple payment options to select from, and they can pay conveniently for the recently placed order</p>
                        </div>
                    </li>
                    <li>
                        <span>3</span>
                        <div class="app-feature-type">
                            <h5>SEO Optimized Site</h5>
                    ...
                    <li>
                        ...
                        <div class="app-feature-type">
                            ...
                            <p>Our Experts Crafted All The Features Of The App In Native Languages Of IOS & Android To Provide A Compatible Service And Make A Presence In All The Types Of Technologies.</p>
                        </div>
                    </li>
                    <li>
                        <span>5</span>
                        <div class="app-feature-type">
                            ...
                            <p>We provide an option for the customers to enjoy promos and offers which increases retention and engagement.The Offers can be created by store and promo can be created by admin.</p>
                        </div>
                    </li>
                    <li>
                        <span>6</span>
                        <div class="app-feature-type">
                            <h5>Product Multiple Images</h5>
                            <p>The users can place the order as per their desired choice by searching and finding product images. Actually, this option is so cool for the users to get groceries.</p>
                        </div>
                    </li>
                    <li>
                        <span>7</span>
                        <div class="app-feature-type">
                            <h5>Quick Search</h5>
                            <p>Browse and search for find your fit from all available product in the user app and website</p>
                        </div>
                    </li>
                    <li>
                        <span>8</span>
                        <div class="app-feature-type">
                            <h5>Date & Time</h5>
                            <p>Infuse an undertone of congruity into the realms of the user's agenda by accrediting them to schedule the order and delivery of groceries as per their convenience.</p>
                        </div>
                    </li>
                  </ul>
                </div>
