...
function Accordian(){
  ...
  <Accordion.Item eventKey="0">
    <Accordion.Header>How Much it Costs To Develop A Grocery Delivery App?</Accordion.Header>
    <Accordion.Body>
    
                                    The cost of developing a Grocery delivery app is dependent on the complexity of functionalities in the app. A multi-vendor app costs much more than a single vendor app.
  ...
  <Accordion.Item eventKey="1">
    <Accordion.Header>How long it takes to develop a Grocery delivery app?</Accordion.Header>
    <Accordion.Body>
