     ...
     <div class="container">
       <div class="row">
         <div class="top-new-top-clickitle text-center">
           <h2>Top Features</h2>
           <p>We strive to create something that doubles up your revenues and attracts more service to your business with an attractive UI/UX that will make your customers come back with the assistance of our well known Grocer delivery clone script. It’s time to develop on demand Grocer delivery app for your business and fly upwards with revenues</p>
         </div>
       </div>
     </div>
                  ...
                  <ul>
                    ...
                    <li>
                        ...
                        <div class="app-feature-type">
                            ...
                            <p>The users can place the order as per their desired time by usinMedicineg this schedule option. Actually, this option is so cool for the users to get s.</p>
                        </div>
                    </li>
                    <li>
                        <span>3</span>
