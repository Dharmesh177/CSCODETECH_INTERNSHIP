            ...
            <div class="col-lg-12">
              <Accordion defaultActiveKey={["0"]} alwaysOpen flush>
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    {" "}
                    How much time does it take to develop a IoT application project?
                  </Accordion.Header>
                  <Accordion.Body>
                ...
                <Accordion.Item eventKey="1">
                  <Accordion.Header>
                    How to hire a dedicated team or developer for my IoT
                    project?
                  </Accordion.Header>
                  <Accordion.Body>
                    <div class="panel-body">
                      ...
                      <p>
                        - We will make you talk to the head of the IoT
                        department.
                      </p>
                ...
                <Accordion.Item eventKey="5">
                  ...
                  <Accordion.Body>
                    ...
                    <a
                      class="internal-links"
                      href="IoT-app-development.shtml"
                    >
                      IoT app development
                    </a>{" "}
                    service and output.
                ...
                <Accordion.Item eventKey="6">
                  <Accordion.Header>
                    IoT Development Team or Single Developer, What is the
                    best choice?
                  </Accordion.Header>
                  <Accordion.Body>
                    ...
                    excellent IoT developers. Still, a team always makes the
                    best output as more brains are working on a similar project.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="7">
                  <Accordion.Header>
                    What is the Average cost of developing an IoT
                  ...
                  <Accordion.Body>
                    <div class="panel-body">
                      ...
                      <p>- Size of the IoT App project.</p>
                      <p>
