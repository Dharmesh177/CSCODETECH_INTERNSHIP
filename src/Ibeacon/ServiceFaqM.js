            ...
            <div class="col-lg-12">
              <Accordion defaultActiveKey={["0"]} alwaysOpen flush>
                <Accordion.Item eventKey="0">
                  <Accordion.Header>
                    {" "}
                    How much time does it take to develop a ibeacon application project?
                  </Accordion.Header>
                  <Accordion.Body>
                ...
                <Accordion.Item eventKey="1">
                  <Accordion.Header>
                    How to hire a dedicated team or developer for my ibeacon
                    project?
                  </Accordion.Header>
                  <Accordion.Body>
                    <div class="panel-body">
                      ...
                      <p>
                        - We will make you talk to the head of the ibeacon
                        department.
                      </p>
                ...
                <Accordion.Item eventKey="5">
                  ...
                  <Accordion.Body>
                    ...
                    <a
                      class="internal-links"
                      href="ibeacon-app-development.shtml"
                    >
                      ibeacon app development
                    </a>{" "}
                    service and output.
                ...
                <Accordion.Item eventKey="6">
                  <Accordion.Header>
                    ibeacon Development Team or Single Developer, What is the
                    best choice?
                  </Accordion.Header>
                  <Accordion.Body>
                    ...
                    excellent ibeacon developers. Still, a team always makes the
                    best output as more brains are working on a similar project.
                  </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="7">
                  <Accordion.Header>
                    What is the Average cost of developing an ibeacon
                  ...
                  <Accordion.Body>
                    <div class="panel-body">
                      <p>
                        ...
                        developing an ibeacon Application.
                      </p>
                      <p>- Size of the ibeacon App project.</p>
                      <p>
