          ...
          <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-6" >
              <div class="text-left mauto">
                ...
                <img class="" loading="lazyload" data-src="img/website-service-img.png" src="img/website-service-img.png" alt="Out of the Box Nodejs Development" title="Out of the Box Nodejs Development" width="620" height="490"/>
         
                </div>
                <h1 data-aos="fade-in" class="section-title mb-30">Out of the Box Nodejs Development</h1>
                <p><a href="#" class="internal-links">CSCODETECH</a>' has an exceptional team of NodeJS experts who develop beautiful websites that provide the best user experience on the websites.</p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-7 col-md-12 text-left">
              ...
              <h2 class="section-title mb-30">Top NODEJS Website Development</h2>
              </div>
